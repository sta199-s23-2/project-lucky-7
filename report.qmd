...
For the data analysis, we intend to utilize visualizations of the regional and global homicide statistics to derive our findings as related to our first question. For the second question, we will be using a visualization with gender breakdown **(DRAFT note: can do regionally if needed)**. For the third question, we will be utilizing a series of regressions to determine the level of correlation between homicides and GDP.
...
### **R.1 - Global +Regional - Homicide Statistics 2005-2020**
