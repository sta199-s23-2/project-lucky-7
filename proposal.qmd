...
-   Write a brief description of the observations.
    ...
    **The gva data set specifies how different sectors of the economy added to overall economic activity. The agriculture, industry, and services sectors of the economy are detailed in this graph. The trends and patterns of each country through the years 1995-2020, such as the growth of the sector economy and decrease of the agriculture sector, are also displayed. The gpa data set shows the gap of each country through the years 1995-2020, demonstrating how many countries have managed to increase their GDP substantially. Additionally, these data sets are a factual representation of the economic growth and did not pose a threat to the individuals in these countries. Since no civilian was impacted by the methods used to obtain the data, there are no ethical concerns.**
