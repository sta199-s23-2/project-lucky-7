...
gdp_un_total$ValueGDP <- as.numeric(as.character(gdp_un_total$ValueGDP)) #conversion to numeric, NOT WORKING FOR SOME REASON, NEED to find out, is causing NAs
...
**Total Linear Regression Model (With GDP):**
...
1.  Worldwide violence, based on sex: **(FIXED)**
...
homicides_and_crime_un_sex |>
  ...
  labs(
    x = "Year",
    y = "% of International Homicide Victims",
